        ...
        <div id="sidebar-wrapper" aria-hidden="true">
            <ul class="sidebar-nav nav-pills nav-stacked" id="menu" aria-hidden="true">
                ...
                <li>
                    ...
                    <ul class="nav-pills nav-stacked" style="list-style-type:none;">
                        <li><a href="allblog"><span class="fa-stack fa-lg pull-left"><i class="fa fa-flag fa-stack-1x "></i></span>Read</a></li>
                ...
                <li>
                  ...
                  <ul class="nav-pills nav-stacked" style="list-style-type:none;">
                        <li><a href="allforums"><span class="fa-stack fa-lg pull-left"><i class="fa fa-cart-plus fa-stack-1x "></i></span>Join forums</a></li>
                        <li><a href="forumpage"><span class="fa-stack fa-lg pull-left"><i class="fa fa-cart-plus fa-stack-1x"></i></span>Add a New Forum</a></li>
