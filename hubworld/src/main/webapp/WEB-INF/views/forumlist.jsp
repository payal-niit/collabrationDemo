    ...
    <tbody>
      <tr ng-repeat="group in userList">
        ...
        <td>{{group.forumId}}</td>
						...
						<td><a class="btn btn-info glyphicon glyphicon-info-sign" href="viewforumdetail--{{group.forumId}}--forum"></a>
						<!-- <a class="btn btn-warning glyphicon glyphicon-edit" href=""></a> -->											
						<a class="btn btn-danger glyphicon glyphicon-remove-sign" href="forum/remove/{{group.forumId}}"></a>
