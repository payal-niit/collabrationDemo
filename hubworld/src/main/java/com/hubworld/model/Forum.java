...
public class Forum {
	...
	public String toString() {
		...
		return "{forumId : '" + forumId + "'," + "username : '" + username + "'," + "forumName :'" + forumName + "',"
				+ "forumCategory :'" + forumCategory + "'," + "forumDescription :'" + forumDescription + "',"
				+ "dateOfCreation :'" + dateOfCreation + "'," + "forumImage :'resources/images/" + forumId + ".jpg'}";
	}
